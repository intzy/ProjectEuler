...
| 007     | [10001st prime](https://projecteuler.net/problem=007)                         | 5%         | 0.009            | Sieve of Eratosthenes.  It is worth is to design a fast sieve since you will be using it a lot.                                                                                                                                            |
...
| 044     | [Pentagon numbers](https://projecteuler.net/problem=044)                      | 5%         | 0.258            | Almost all solutions that I have seen to this problem are incorrect since they do no prove that the difference is minimal.  Your code should find this difference AND prove that the difference is minimal.                                |
