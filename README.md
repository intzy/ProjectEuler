...
| 173     | [Using up to one million tiles how many different "hollow" square laminae can be formed?](https://projecteuler.net/problem=173)                 | 30%        | [0.000](src.pb173.py)   |
| 174     | [Counting the number of "hollow" square laminae that can form one, two, three, ... distinct arrangements](https://projecteuler.net/problem=174) | 40%        | [0.459](src/pb174.py)   |
...
| 351     | [Hexagonal orchards](https://projecteuler.net/problem=351)                                                                                      | 25%        | [0.452](src/pb351.py)   |
...
| 764     | [Asymmetric Diophantine Equation](https://projecteuler.net/problem=764)                                                                         | Recent     | [23.670](src/pb764.py)  |
